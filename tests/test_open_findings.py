...
def test_b2_frame_resize_markers_present():
    """Finding B2 (REVIEW.md 2026-06-10): workflows disagreed on what a
    Createc frame resize preserves (centre vs top edge). The suspect survey
    zoom path was removed in the 2026-06 merge (superseded by
    feature_centerer + sweep panel), but the underlying rig question is
    still open, so the FIXME stays attached to the convention
    source-of-truth and the mock that cannot yet detect the bug.
    """
