...
class SurveyManifest:
    ...
    def save(self, path: Path) -> None:
        # Atomic write (temp file + replace): the manifest is rewritten
        # after every feature, and a crash mid-write must not corrupt the
        # one file a partial campaign needs for recovery.
